...
sunnypilot/selfdrive/controls/lib/nnlc/model.py, unchanged. Pure-numpy
evaluator for the twilsonco Flux-exported torque models — the 'σ' activation
rename is a Julia export artifact. Weights ship in ./data (see its LICENSE).
"""
