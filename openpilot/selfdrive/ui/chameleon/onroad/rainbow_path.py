...
Ported to chameleonpilot from sunnypilot's selfdrive/ui/sunnypilot/onroad/rainbow_path.py.
"""
import time
import colorsys
import pyray as rl
...
class RainbowPath:
  ...
  def set_lightness(self, lightness: float) -> None:
  ...
  def get_gradient(self) -> Gradient:
    ...
    for i in range(self.num_segments):
      ...
      segment_colors.append(self._hsla_to_color(hue / 360.0, self.saturation, self.lightness, alpha))
  ...
  def draw_rainbow_path(self, rect, path) -> None:
