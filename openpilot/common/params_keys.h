...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"ChameleonBrightness", {PERSISTENT, INT, "0"}},
    ...
    {"RoadNameDisplay", {PERSISTENT, BOOL}},
